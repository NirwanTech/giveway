...
async def on_message(message):
    ...
    if message.content.upper().startswith("$WWESALES"):
        embed = dsicord.Embed(title="129x WWE Premium Accounts", description="We have stocked up on WWE Premium Accounts, and are selling them for £1 / $1.40", color=0x8000ff)
        embed.add_field(name="AltShop Selly Link", value="https://selly.gg/@Hackerable")
...
client.run("NDI5MzcxMDAzMjQwNTc5MDcz.DaAqbQ.EenSqUQpaCBbp_L-2UOyaMxjJMc")
